...
用法：
  python query_video_status.py food_058_single cogvideo5b
"""
import sys
import sqlite3
...
def main():
    if len(sys.argv) != 3:
        print("用法：python query_video_status.py <sample_id> <modelname>")
        print("例如：python query_video_status.py food_058_single cogvideo5b")
        sys.exit(1)
